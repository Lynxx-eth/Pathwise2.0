...
// Feed + receipt icons (UI polish: system vectors, never raw emojis).
type FillableProps = IconProps & { filled?: boolean };

export const HeartIcon = ({ cls = "icon", style, filled = false }: FillableProps) => (
  <svg {...base(cls)} style={style} fill={filled ? "currentColor" : "none"}>
    <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7z" />
  </svg>
);

export const BookmarkIcon = ({ cls = "icon", style, filled = false }: FillableProps) => (
  <svg {...base(cls)} style={style} fill={filled ? "currentColor" : "none"}>
    <path d="M19 21l-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
  </svg>
);

export const SearchIcon = ({ cls = "icon", style }: IconProps) => (
  <svg {...base(cls)} style={style}>
...
export const ExternalIcon = ({ cls = "icon", style }: IconProps) => (
  <svg {...base(cls)} style={style}>
    <path d="M15 3h6v6" />
    <path d="M10 14 21 3" />
...
export const PlayIcon = ({ cls = "icon", style }: IconProps) => (
  <svg {...base(cls)} style={style} fill="currentColor">
    <polygon points="6 3 20 12 6 21 6 3" />
  </svg>
);

export const ClockIcon = ({ cls = "icon", style }: IconProps) => (
  <svg {...base(cls)} style={style}>
    <circle cx="12" cy="12" r="10" />
...
export const BellIcon = ({ cls = "icon", style }: IconProps) => (
  <svg {...base(cls)} style={style}>
